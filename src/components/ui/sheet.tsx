...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-slate-950/95 p-6 text-white shadow-2xl transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-300 border border-white/10",
  {
    variants: {
      side: {
